...
# load data  --------------------------------------------------------------
# This is ......
ESIF_2014_20_categ <- readRDS("~/Github/plan2implem/data/rawdata_oct2022/ESIF_2014_20_categ.Rds")
# This is ......
ESIF_2014_20_plan2imp <- readRDS("~/Github/plan2implem/data/rawdata_oct2022/ESIF_2014_20_plan2imp.Rds")
# This is ......
ESIF_2014_20 <- readRDS("~/Github/plan2implem/data/rawdata_oct2022/ESIF_2014_20.Rds")
...
# assert + is_uniq
ERDF_2014_20 %>%  assert(is_uniq, reference_date) %>%
...
# I eliminated the June 30 instances (cant remember why)
